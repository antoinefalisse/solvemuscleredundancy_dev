            ...
            case 'DeGroote2009'
                switch formulation_contdyn
                    ...
                    case 'FtildeState'   
                        [Time_actdyn,MExcitation_actdyn,MActivation_actdyn,...
                            RActivation_actdyn,TForcetilde_actdyn,TForce_actdyn,...
                            lMtilde_actdyn,lM_actdyn,dFTtilde_actdyn,MuscleNames_actdyn,...
                            OptInfo_actdyn,DatStore_actdyn]=...
                            SolveMuscleRedundancy_FtildeState_actdyn_CasADi_col(...
                            model_path,IK_path,ID_path,time,Out_path,Misc);
                        
                        [Time_actdyn2,MExcitation_actdyn2,MActivation_actdyn2,...
                            RActivation_actdyn2,TForcetilde_actdyn2,TForce_actdyn2,...
                            lMtilde_actdyn2,lM_actdyn2,dFTtilde_actdyn2,MuscleNames_actdyn2,...
                            OptInfo_actdyn2,DatStore_actdyn2]=...
...
for i = 1:9
    subplot(3,3,i)
        plot(Time_actdyn.meshPoints,MActivation_actdyn.meshPoints(:,i),...
            'linewidth',3);
        hold on
        plot(Time_actdyn2.meshPoints,MActivation_actdyn2.meshPoints(:,i),...
            'linewidth',3,'linestyle',':'); 
        set(gca,'fontsize',16)
        
end
legend('New implementation','Original Implementation')
suptitle('Muscle activations')

figure()
for i = 1:9
    subplot(3,3,i)
        plot(Time_actdyn.collocationPointsOnly,dFTtilde_actdyn.collocationPointsOnly(:,i),...
            'linewidth',3);
        hold on
        plot(Time_actdyn2.meshPoints(1:end-1),dFTtilde_actdyn2.meshPoints(:,i),...
            'linewidth',3,'linestyle',':');   
        set(gca,'fontsize',16)
end
legend('New implementation','Original Implementation')
