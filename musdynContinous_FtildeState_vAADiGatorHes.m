...
function phaseout = musdynContinous_FtildeState_vAADiGatorHes(input)
global ADiGator_musdynContinous_FtildeState_vAADiGatorHes
if isempty(ADiGator_musdynContinous_FtildeState_vAADiGatorHes); ADiGator_LoadData(); end
Gator1Data = ADiGator_musdynContinous_FtildeState_vAADiGatorHes.musdynContinous_FtildeState_vAADiGatorHes.Gator1Data;
Gator2Data = ADiGator_musdynContinous_FtildeState_vAADiGatorHes.musdynContinous_FtildeState_vAADiGatorHes.Gator2Data;
...
cadainput2_1.dV = a.dV;
cadainput2_1.f = a.f;
%User Line: cadainput2_1 = a;
cadainput2_2.dV = Ftilde.dV;
cadainput2_2.f = Ftilde.f;
%User Line: cadainput2_2 = Ftilde;
cadainput2_3.dV = dFtilde.dV;
cadainput2_3.f = dFtilde.f;
...
Hilldiff.dVdV = cadaoutput2_1.dVdV; Hilldiff.dV = cadaoutput2_1.dV;
Hilldiff.f = cadaoutput2_1.f;
%User Line: Hilldiff = cadaoutput2_1;
F.dV = cadaoutput2_2.dV;
F.f = cadaoutput2_2.f;
...
for cadaforcount1 = 1:3
    ...
    cada1tf2 =  ones(9,1);
    cada1tf1 =  zeros(9,9);
    cada2f1 = cada1tf2(Gator1Data.Index12);
...
w2.f = 0.01;
%User Line: w2 = 0.01;
cada2f1dV = 1.*a.f.^(1-1).*a.dV;
cada2f1 = a.f.^1;
cada2f2dV = 2.*cada2f1dV;
cada2f2 = 2*cada2f1;
cada1f1dVdV = a.dV.*cada2f2dV;
cada1f1dV = cada2f2.*a.dV;
cada1f1 = a.f.^2;
cada1tf2 =  ones(9,1);
cada1tf1 =  zeros(9,9);
cada2f1 = cada1tf2(Gator1Data.Index22);
cada1tf1(Gator1Data.Index23) = cada2f1;
cada2tf1 = zeros(9,9);
cada2tf1(Gator2Data.Index2) = cada1tf1(Gator2Data.Index1);
...
cada1tf2 =  ones(3,1);
cada1tf1 =  zeros(3,3);
cada2f1 = cada1tf2(Gator1Data.Index24);
cada1tf1(Gator1Data.Index25) = cada2f1;
cada2tf1 = zeros(3,3);
...
cada2td1(:,Gator2Data.Index5) = cada2f2dV;
...
cada1tf2 =  ones(9,1);
cada1tf1 =  zeros(9,9);
cada2f1 = cada1tf2(Gator1Data.Index28);
cada1tf1(Gator1Data.Index29) = cada2f1;
cada2tf1 = zeros(9,9);
cada2tf1(Gator2Data.Index9) = cada1tf1(Gator2Data.Index8);
cada1f9dVdV = cada1f8dVdV*cada2tf1;
...
cada2td1(:,Gator2Data.Index10) = cada2f2dV;
...
phaseout.integrand.dVdV_location = [phaseout.integrand.dV_location(Gator2Data.Index13,:), Gator2Data.Index14];
phaseout.path.dVdV_size = [phaseout.path.dV_size,40];
phaseout.path.dVdV_location = [phaseout.path.dV_location(Gator2Data.Index15,:), Gator2Data.Index16];
end
function [err,FT] = ADiGator_ForceEquilibrium_FtildeState(a,fse,dfse,lMT,vMT,params,Fvparam,Fpparam,Faparam,Atendon)
global ADiGator_musdynContinous_FtildeState_vAADiGatorHes
Gator1Data = ADiGator_musdynContinous_FtildeState_vAADiGatorHes.ADiGator_ForceEquilibrium_FtildeState.Gator1Data;
Gator2Data = ADiGator_musdynContinous_FtildeState_vAADiGatorHes.ADiGator_ForceEquilibrium_FtildeState.Gator2Data;
% ADiGator Start Derivative Computations
cada1f1 = size(a.f,1);
cada1f2 = ones(cada1f1,1);
cada1f3 = params(1,:);
...
global ADiGator_musdynContinous_FtildeState_vAADiGatorHes
ADiGator_musdynContinous_FtildeState_vAADiGatorHes = load('musdynContinous_FtildeState_vAADiGatorHes.mat');
return
end